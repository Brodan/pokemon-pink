...
BugIconFrame1:       INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_1
PlantIconFrame1:     INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_1
BugIconFrame2:       INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_2
PlantIconFrame2:     INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_2
SnakeIconFrame1:     INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_1
QuadrupedIconFrame1: INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_1
SnakeIconFrame2:     INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_2
QuadrupedIconFrame2: INCBIN "gfx/icons/ditto.2bpp", INC_FRAME_2
